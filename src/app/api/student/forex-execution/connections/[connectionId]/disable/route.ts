...
import { disableStudentForexConnection } from "@/lib/crypto-execution/forex-connection-repository";
...
export async function POST(
  ...
  try {
    ...
    await disableStudentForexConnection(actor, params.connectionId);
