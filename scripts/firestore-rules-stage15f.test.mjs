...
const protectedPaths = [
  ...
  `workspaces/${workspaceId}/trade_copier_payment_intents/trade_copier_payment_rules`,
  `workspaces/${workspaceId}/trade_copier_audit_events/trade_copier_audit_rules`,
  ...
  `workspaces/${workspaceId}/students/${studentId}/trade_copier_subscriptions/current`,
  `workspaces/${workspaceId}/students/${studentId}/trade_copier_cleanup_tasks/legacy_subscription_cleanup`,
